<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="{{url('/pendaftar')}}">Sistem Presensi</a>
    </div>
    {{-- <div class="sidebar-brand sidebar-brand-sm">
      <a href="{{url('/pendaftar')}}">SKD</a>
</div> --}}
<ul class="sidebar-menu">
  <li class="@yield('status-beasiswa')"><a class="nav-link" href="{{url('/admin/akun')}}"><i
        class="fas fa-graduation-cap"></i> <span>Managemen Akun</span></a>
  </li>
</ul>
